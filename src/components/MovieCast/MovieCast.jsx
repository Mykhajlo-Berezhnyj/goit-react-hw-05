      ...
      {error && <ErrorMessage message={error} />}
          {cast.length > 0 ? (
              <>
                  ...
                  <button type='button' onClick={hundleLoadCast} className={css['btn-load-more']} disabled={visibleCount >= cast.length} aria-label="Load more cast members">Load more</button>
